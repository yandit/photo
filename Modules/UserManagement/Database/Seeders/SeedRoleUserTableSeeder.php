...
class SeedRoleUserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('roles')->insert([
            'slug' => 'company',
            'name' => 'Company',
            'permissions' => '{"googledrivegallery.index":true,"googledrivegallery.edit":true,"googledrivegallery.delete":true,"googledrivegallery.create":true,"googledrivecredential.index":true,"googledrivecredential.edit":true,"googledrivedisk.create":true,"googledrivedisk.index":true,"googledrivedisk.edit":true,"googledrivedisk.delete":true,"stickableframe.create":true,"stickableframe.index":true,"stickableframe.edit":true,"stickableframe.delete":true,"customer.create":true,"customer.index":true,"customer.edit":true,"customer.delete":true,"googledrivegallery.list":true,"googledrivegallery.update":true,"googledrivegallery.store":true,"googledrivecredential.list":true,"googledrivecredential.update":true,"googledrivedisk.store":true,"googledrivedisk.list":true,"googledrivedisk.update":true,"stickableframe.store":true,"stickableframe.list":true,"stickableframe.update":true,"customer.store":true,"customer.list":true,"customer.update":true}',
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            'updated_at' => Carbon::now()->format('Y-m-d H:i:s')
        ]);
    }
