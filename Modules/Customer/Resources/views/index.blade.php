          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="text-center" style="margin-bottom: 30px">
                <a class="btn btn-sm btn-success" href="{{ route('customer.create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>
        ...
        var settings = {
          ...
          columns: [
            ...
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-xs btn-success btn-space" href="'+ ADMIN_URL + '/customer/edit/' + data.id +'" role="button"><i class="fa fa-pencil"></i> Edit</a>';
              var deleteButton = '<a class="btn btn-xs btn-success deleteDialog" href="'+ ADMIN_URL + '/customer/delete/' + data.id +'" data-title="'+data.name+'" role="button"><i class="fa fa-trash"></i> Delete</a>';
