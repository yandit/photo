                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="fname" placeholder="Customer" onkeyup="slugify(this,'#fslug')"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fslug" placeholder="Slug" name="slug" value="{{ (old('slug')) ? old('slug') : $customer->slug }}" onkeypress="slugFormat(event)"
                        ...
                        <div class="form-group {{ $errors->first('status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="status" id="fstatus" required
                                ...
                                @foreach (config('customer.enable_disable') as $status)
                                    @php
                                        $selected = old('status', $customer->status) == $status['value'] ? 'selected' : '';
                                    @endphp
