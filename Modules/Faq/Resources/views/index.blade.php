          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="text-center" style="margin-bottom: 30px">
                <a class="btn btn-sm btn-danger" href="{{ route('faq.create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>
        ...
        var settings = {
          ...
          columns: [
            ...
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-xs btn-danger btn-space" href="'+ ADMIN_URL + '/faq/edit/' + data.id +'" role="button"><i class="fa fa-pencil"></i> Edit</a>';
              var deleteButton = '<a class="btn btn-xs btn-danger deleteDialog" href="'+ ADMIN_URL + '/faq/delete/' + data.id +'" data-title="'+data.question+'" role="button"><i class="fa fa-trash"></i> Delete</a>';
