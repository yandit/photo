          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="text-center" style="margin-bottom: 30px">
                <a class="btn btn-sm btn-danger" href="{{ route('stickableframe.create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>
                <a class="btn btn-sm btn-danger" href="#" data-toggle="modal" data-target="#modal-filter" role="button"><i class="fa fa-filter"></i> Filter</a>
        ...
        var settings = {
          ...
          columns: [
            ...
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-xs btn-danger btn-space" href="'+ ADMIN_URL + '/frames/stickable/' + data.id +'/edit" role="button"><i class="fa fa-pencil"></i> Edit</a>';
              var deleteButton = '<a class="btn btn-xs btn-danger deleteDialog" href="'+ ADMIN_URL + '/frames/stickable/delete/' + data.id +'" data-title="'+data.title+'" role="button"><i class="fa fa-trash"></i> Delete</a>';
          ...
          ajax : {
              ...
              crossDomain : true,
              url : ADMIN_URL + '/frames/stickable/list',
              type : 'POST',
