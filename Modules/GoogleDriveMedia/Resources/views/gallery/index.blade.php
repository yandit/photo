        ...
        var settings = {
          ...
          columns: [
            ...
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-xs btn-warning btn-space" href="'+ ADMIN_URL + '/google-drive/gallery/edit/' + data.id +'" role="button"><i class="fa fa-pencil"></i> Edit</a>';
              return editButton ;
            }}
          ],
          ajax : {
              ...
              crossDomain : true,
              url : ADMIN_URL + '/google-drive/gallery/list',
              type : 'POST',
