        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-8 col-md-12 col-sm-12 col-xs-12"
                    ...
                    <h1>Pick your <em>Memories</em> and bring them to life.</h1>
                    <p>Select your best memorable memories, and let us do the rest.</p> 
                    <a href="{{ route('upload.index') }}" class="main-button-slider">Choose your memories</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                ...
                <div class="features-item">
                    <div class="features-icon">
                        <h2>01</h2>
                        <img src="{{ asset('fe/images/features-icon-1.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                ...
                <div class="features-item">
                    <div class="features-icon">
                        <h2>02</h2>
                        <img src="{{ asset('fe/images/features-icon-2.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                ...
                <div class="features-item">
                    <div class="features-icon">
                        <h2>03</h2>
                        <img src="{{ asset('fe/images/features-icon-3.png') }}" alt="">
                        <h4>Email Design</h4>
                        <p>Curabitur pulvinar vel odio sed sagittis. Nam maximus ex diam, nec consectetur diam.</p>
                        <a href="#testimonials" class="main-button">
                            More Detail
    ...
    <div class="container">
        <div class="row">
            <div class="left-image col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix-big"
                data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <img src="{{ asset('fe/images/left-image.png') }}" class="rounded img-fluid d-block mx-auto" alt="App">
            </div>
            <div class="right-text offset-lg-1 col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix">
                <ul>
                    <li data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="{{ asset('fe/images/about-icon-01.png') }}" alt="">
                        <div class="text">
                    ...
                    <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                        <img src="{{ asset('fe/images/about-icon-02.png') }}" alt="">
                        <div class="text">
                    ...
                    <li data-scroll-reveal="enter right move 30px over 0.6s after 0.6s">
                        <img src="{{ asset('fe/images/about-icon-03.png') }}" alt="">
                        <div class="text">
            ...
            <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="{{ asset('fe/images/testimonial-author-1.png') }}" alt="Author One"></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="{{ asset('fe/images/testimonial-author-1.png') }}" alt="Second Author"></i>
                        </div>
                        <div class="testimonial-content">
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="{{ asset('fe/images/testimonial-author-1.png') }}" alt="Author Third"></i>
                        </div>
                        <div class="testimonial-content">
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="{{ asset('fe/images/testimonial-author-1.png') }}" alt="Fourth Author"></i>
                        </div>
                        <div class="testimonial-content">
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
